...
import 'package:infokos/views/pemilik/nav_screen/edit_kos_tabs/detail_kos_pemilik/detail_kos_pemilik.dart';

class SudahPublishTab extends StatelessWidget {
  const SudahPublishTab({super.key});
