...
import 'package:infokos/views/pencari/auth/register_pencari_screen.dart';
import 'package:infokos/views/pencari/main_pencari_screen.dart';
...
class _LoginPencariScreenState extends State<LoginPencariScreen> {
  ...
  _loginUsers() async {
    ...
    if (_formkey.currentState!.validate()) {
      String res = await _authController.loginPencari(email, password);
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.push(context,
                          ...
                          return const RegisterPencariScreen();
                        }));
                      },
